...
function recalculate() {
  var constLabel = document.getElementById("calculated-cost");
  if (modelName == "XYZ") {
    constLabel = duration * 100;
  } else {
    constLabel = duration * 213;
  }
  document.getElementById("calculated-cost").innerHTML = constLabel;
}
...
if (durationBtn) durationBtn.addEventListener("click", changeDuration);
